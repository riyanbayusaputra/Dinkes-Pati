    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('questionnaires.index') }}"><i class="fas fa-poll"></i>
                        Kuesioner</a></div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                @if($superadmin)
                                <a href="{{ route('questions.create', $questionnaire->id) }}"
                                ...
                                <div
                                        ...
                                        <div>
                                            ...
                                            <form action="{{ route('questions.destroy', $question->id) }}" method="POST"
                                                ...
                                                <button type="submit" class="btn btn-sm btn-danger"
                                                    data-toggle="tooltip" title="Hapus Pertanyaan"
                                    ...
                                    <div class="mt-3">
                                        <p class="mb-2 text-muted">
                                            {{-- <i
                                                class="fas {{ $question->type === 'multiple_choice' ? 'fa-dot-circle' : 'fa-check-square' }} mr-2"></i>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <div
                                                    class="custom-control {{ $question->type === 'multiple_choice' ? 'custom-radio' : 'custom-checkbox' }}">
                                                    <input
                                                        type="{{ $question->type === 'multiple_choice' ? 'radio' : 'checkbox' }}"
                                                        id="option-{{ $option->id }}"
                                                        name="question-{{ $question->id }}" class="custom-control-input"
                                                        disabled>
