            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="/questionnaires/{{ $prevQuestionnaire->id }}/responses"
                        ...
                        <a href="/questionnaires/{{ $nextQuestionnaire->id }}/responses"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">{{ ($responses->currentpage()-1) * $responses->perpage() +
                                        $key + 1 }}</td>
                                    <td>{!! $response->nama_responden ?? '<span class="text-secondary">Anonymous</span>'
                                        !!}</td>
