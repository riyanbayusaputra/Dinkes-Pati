...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('fonts/myriad-pro/MyriadPro-Regular.woff') }}">
    ...
    <style>
        ...
        body {
            ...
            color: #9197a4;
            overflow-x: hidden;
            /* Menyembunyikan elemen yang melampaui lebar layar */
        }
        ...
        .content {
            padding-top: 80px;
            /* Adjust padding to avoid content being hidden under the fixed navbar */
        }
        ...
        .hero {
            ...
            top: 0;
            left: 0px;
            /* Pastikan tidak ada jarak antara header dan hero */
            margin-bottom: 30px;
            height: auto;
        }
        ...
        .hero-video {
            ...
            overflow: hidden;
            position: relative;
            /* Untuk menempatkan overlay di atas video */
            padding: 0;
            margin: 0;
            top: 0;
            /* Pastikan videonya sejajar dengan header */
        ...
        .hero-video video {
            ...
            height: auto;
            object-fit: cover;
            /* Memastikan video mengisi area yang tersedia */
        }

        .overlay {
            position: absolute;
            /* Memungkinkan layer untuk berada di atas video */
            top: 0;
            left: 0;
            width: 100%;
            height: 100%;
            ...
            z-index: 1;
            /* Memastikan layer berada di atas video */
        }

        .overlay-text {
            position: absolute;
            /* Allows text to be over the video */
            top: 45%;
        ...
        .sub-message {
            ...
            margin-top: 0.5rem;
            /* Add margin to space it from welcome-message */
        }

        /* Tambahan untuk memastikan tidak ada elemen lain yang terpengaruh */
        .container {
            position: relative;
            /* Memastikan container dapat menampung elemen di dalamnya */
        }
        ...
        .features {
            display: flex;
            justify-content: center;
            /* Menyebar item dengan lebih rapi */
            align-items: center;
            background-color: #2469A5;
            /* Ubah ke warna latar belakang putih */
            padding: 40px;
            /* Sesuaikan padding untuk lebih banyak ruang */
            border-radius: 0px;
            ...
            top: -30px;
            z-index: 1;
            /* Pastikan elemen berada di atas */
            width: 100%;
            margin: 0 auto;
            margin-top: 0px;
            /* gap: 100px; */
        ...
        .feature-item {
            display: flex;
            flex-direction: row;
            /* Mengubah arah flex untuk gambar di atas teks */
            align-items: center;
        ...
        .feature-item img {
            ...
            max-height: 80px;
            /* Ukuran ikon yang lebih besar, ubah sesuai kebutuhan */
        ...
        .feature-item img:hover {
            ...
            /* Mengubah gambar menjadi putih saat hover */
        }
        ...
        .feature-item::after {
            ...
            position: absolute;
            right: 0px;
            filter: brightness(0) saturate(100%) invert(28%) sepia(84%) saturate(611%) hue-rotate(166deg) brightness(120%) contrast(120%);
        }
        ...
        .gallery-wrapper {
            overflow: hidden;
            /* Hanya tampilkan sebagian galeri yang muat dalam kontainer */
            width: 100%;
            position: relative;
        }
        ...
        .gallery-item {
            text-align: left;
            width: 350px;
            /* or a percentage for responsiveness */
            align-items: center;
            /* Menempatkan gambar di tengah secara vertikal */
        }
        ...
        .thumbnail-item {
            margin: 0 10px;
            /* Add horizontal spacing between thumbnails */
        }
        ...
        .help-item {
            ...
            /* Bayangan lembut untuk kotak */
            border-radius: 5px;
            padding: 20px;
            width: 75%;
            /* Membuat lebar kotak sesuai dengan kolom grid */
            height: 200px;
            /* Tinggi standar untuk setiap kotak */
            text-align: center;
            transition: transform 0.3s ease;
        }
        ...
        .bottom-info {
            ...
            /* Existing margin */
            margin-bottom: 5px;
            /* Add this line to create space below */
            text-align: left;
            padding-left: 60px;
            padding-right: 40px;
            padding-top: 50px;
        ...
        .greeting-content {
            display: flex;
            align-items: flex-start;
            /* Mengubah ke flex-start untuk mendorong elemen ke atas */
        ...
        .greeting-text {
            ...
            margin-left: 150px;
            margin-top: -20px;
            /* Sesuaikan nilai ini untuk menaikkan lebih lanjut */
        }
        ...
        .greeting-image {
            ...
            /* Menaikkan gambar menggunakan transform */
        }
        ...
        .action-button {
            ...
            margin-top: 15px;
            /* Add margin for spacing from sub-message */
            transition: background-color 0.3s;
            /* Smooth transition for hover effect */
            text-decoration: none;
            /* Remove underline */
            display: inline-block;
            /* Tampil normal pada desktop */
        }
        ...
        .help-item:last-child a {
            color: white;
            /* Ensure headings, paragraphs, and links have white text */
        }
        ...
        @media (max-width: 768px) {
            ...
            .navbar-nav.active {
                ...
                position: absolute;
                top: 60px;
                /* Sesuaikan dengan posisi navbar */
                left: 0;
                background-color: #fff;
                /* Latar belakang navbar dropdown */
            ...
            .feature-item {
                display: none;
                /* Sembunyikan feature-item pada tampilan mobile */
            }
        ...
        font-size: 14px;
            ...
            .video-main img {
                width: 100%;
                /* Memastikan video tetap menyesuaikan lebar layar */
                height: auto;
                /* Menjaga rasio aspek video */
                padding: 10px;
                /* Mengurangi padding pada ukuran layar lebih kecil */
                border-radius: 5px;
                /* Sudut yang lebih lembut pada layar kecil */
            }
            ...
            .video-main iframe {
                width: 100%;
                /* Video will take full width of its container */
                height: auto;
            ...
            .video-thumbnails {
                flex-direction: column;
                /* Ubah thumbnail menjadi satu kolom */
                align-items: center;
                /* Pusatkan thumbnail */
                margin-top: 10px;
                /* Kurangi margin di atas thumbnail */
            }

            .thumbnail-item {
                margin: 10px 0;
                /* Tambahkan margin di atas dan bawah untuk spasi antar thumbnail */
            }

            .thumbnail-item img {
                width: 100%;
                /* Buat gambar thumbnail mengisi lebar kontainer */
                height: auto;
                /* Jaga proporsi gambar */
                max-width: 250px;
                /* Tetapkan batas maksimum ukuran thumbnail */
            }

            .view-more {
                margin-top: 15px;
                /* Kurangi margin pada tombol view-more */
                font-size: 0.9rem;
                /* Sesuaikan ukuran teks untuk layar kecil */
                padding: 8px 15px;
                /* Kurangi padding tombol untuk layar kecil */
            }

            .help-section {
                grid-template-columns: 1fr;
                /* Make the help items stack vertically */
                gap: 15px;
            }
            ...
            .action-button {
                display: none;
                /* Menyembunyikan elemen saat ukuran layar <= 768px */
            }
            ...
            .footer {
                font-size: 8px;
                /* Mengurangi ukuran font untuk lebih kecil */
                padding: 2px;
                /* Mengurangi padding untuk footer */
                text-align: center;
                /* Optional: Untuk memastikan footer tetap rata tengah */
            }
            ...
            .welcome-message {
                ...
                padding: 0 10px;
                /* Tambahkan sedikit padding untuk tampilan lebih rapi */
            }
            ...
            .sub-message {
                ...
                padding: 0 10px;
                /* Tambahkan padding agar tidak terlalu rapat di sisi */
            }
        ...
        @media (max-width: 480px) {
            ...
            .video-main img {
                width: 100%;
                /* Video memenuhi layar penuh */
                height: auto;
                /* Menjaga rasio video */
                padding: 5px;
                /* Kurangi padding lebih lanjut */
                border-radius: 5px;
                /* Lebih lembut di perangkat yang lebih kecil */
            }
            ...
            .video-thumbnails {
                flex-direction: column;
                /* Atur thumbnail secara vertikal */
                align-items: center;
                /* Pusatkan thumbnail */
                margin-top: 5px;
                /* Kurangi jarak di atas thumbnail */
            }

            .thumbnail-item img {
                width: 100%;
                /* Buat thumbnail memenuhi lebar kontainer */
                height: auto;
                /* Jaga rasio aspek gambar */
                max-width: 200px;
                /* Maksimum ukuran thumbnail di ponsel */
            }

            .view-more {
                margin-top: 10px;
                /* Kurangi margin di atas tombol */
                font-size: 0.8rem;
                /* Kurangi ukuran teks untuk layar kecil */
                padding: 6px 12px;
                /* Kurangi padding tombol lebih lanjut */
            }
    ...
    <main>
        ...
        <div class="container">
            ...
            <section class="features">
                ...
                <a href="{{ route('kajian') }}" class="feature-item vertical-pip">
                    <img src="{{ asset('images/kajian.png') }}" alt="">
                    <span class="ml-10">Kajian Rumpun</span>
                    <div class="arrow"></div>
                </a>
                <a href="{{ route('petasebaran') }}" class="feature-item vertical-pip">
                    <img src="{{ asset('images/peta.png') }}" alt="">
                    <span class="ml-10">Peta Sebaran</span>
                </a>
            </section>
                ...
                <div class="gallery-wrapper">
                    <div class="gallery">
                        ...
                        <div class="gallery-item">
                            <img src="{{ asset('images/activity-galleries/' . $activity->image) }}"
                ...
                <div class="container">
                    <div class="greeting-content">
                        <div class="greeting-text">
                            ...
                            <p>Puji syukur kita panjatkan kehadirat Allah SWT yang telah melimpahkan kenikmatan kepada
                                kita semua.
                                Tak lupa kami panjatkan rasa syukur kami atas terwujudnya website Dinas Kesehatan
                                Kabupaten Pati sebagai salah satu media informasi bagi masyarakat.</p>
                            <p>Website Dinas Kesehatan Kabupaten Pati merupakan salah satu upaya penyebarluasan
                                informasi seputar program serta kegiatan di Dinas Kesehatan Kabupaten Pati.
                                Kami berharap bahwa website ini selain sebagai media publikasi dan promosi, juga dapat
                                menjadi sarana komunikasi interaktif sehingga memberikan manfaat yang seluas-luasnya
                                bagi semua pihak.</p>
                            <p>Masih banyak kekurangan dalam website ini. Masukan dan saran sangat kami harapkan sebagai
                                koreksi agar website ini menjadi lebih baik.</p>
                ...
                <div class="container">
                    <section class="video-section">
                        ...
                        <div class="video-main">
                            ...
                            @php
                            // Pastikan URL berformat https://www.youtube.com/watch?v=videoId atau
                            ...
                            @endphp
                            @if ($videoId)
                            <iframe width="680" height="415" src="https://www.youtube.com/embed/{{ $videoId }}"
                        ...
                        <div class="video-thumbnails"
                            ...
                            <div class="thumbnail-item" style="cursor: pointer;"
                                onclick="document.querySelector('.video-main iframe').src='https://www.youtube.com/embed/{{ $videoId }}';">
